...
export class TodoService {
  ...
  constructor(private storageSevice: LocalStorageService) { }
  ...
  fetchFromLocalStorage(){
    this.todos = this.storageSevice.getValue<Todo[]>(TodoService.TodoStorageKey) || [];
  ...
  updateToLocalStorage(){
    this.storageSevice.setObject(TodoService.TodoStorageKey, this.todos);
